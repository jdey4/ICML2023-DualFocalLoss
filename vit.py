...
def train_and_save_model(seed):
    ...
    ########
    # checkpoint_path = f"vit_cifar10_seed{seed}.pth"
    ...
    torch.save(model.state_dict(), f"vit_cifar10_seed{seed}.pth")
...
def evaluate_and_save_predictions(model, seed):
    ...
    proba_svhn, svhn_labels = get_predictions(svhn_loader, "SVHN")
    proba_in, cifar10_labels = get_predictions(cifar10_loader, "CIFAR-10 Test")
    ...
    file_to_save = 'dual_focal_vit_'+str(seed)+'.pickle'
