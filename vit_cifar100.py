...
def train_and_save_model(seed):
    ...
    torch.save(model.state_dict(), f"vit_cifar100_seed{seed}.pth")
...
def evaluate_and_save_predictions(model, seed):
    ...
    # Get predictions
    proba_in, cifar100_labels = get_predictions(cifar100_loader, "CIFAR-100")
    ...
    file_to_save = 'dual_focal_vit__cifar100_'+str(seed)+'.pickle'
